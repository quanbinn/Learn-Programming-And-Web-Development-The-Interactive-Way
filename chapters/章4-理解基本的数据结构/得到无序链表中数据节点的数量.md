...
![](/images/章4-理解基本的数据结构/得到无序链表中数据节点的数量/1a1.jpg)
![](/images/章4-理解基本的数据结构/得到无序链表中数据节点的数量/1a2.jpg)

### 运行过程2，如下图所示。

![](/images/章4-理解基本的数据结构/得到无序链表中数据节点的数量/2a1.jpg)

### 运行过程3，如下图所示。

![](/images/章4-理解基本的数据结构/得到无序链表中数据节点的数量/3a1.jpg)

### 运行过程4，如下图所示。

![](/images/章4-理解基本的数据结构/得到无序链表中数据节点的数量/4a1.jpg)
